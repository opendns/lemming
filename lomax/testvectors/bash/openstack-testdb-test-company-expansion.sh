...
./lomax --db="employees" --operation="INSERT" --flag="IGNORE" --table="departments" --random="true" --config=openstack-generic-config.json --user="root" --password="password" --count=1000

# Add newly hired employees to the employees database
./lomax --db="employees" --operation="INSERT" --flag="IGNORE" --table="employees" --random="true" --config=openstack-generic-config.json --user="root" --password="password" --count=1000

# Give low earning employees a 10% salary bonus
./lomax --db="employees" --operation="UPDATE" --table="salaries" --condition="salary=11000 WHERE salary < 10000" --cols=" " --config=openstack-generic-config.json --user="root" --password="password"
